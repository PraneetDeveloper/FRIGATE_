  ...
  console.log("errors",errors);
      ...
      {/* ------------------------- Home_Page_1_Content---------------------------- */}
        <div className='Home_Page1_content pt-3'>
          ...
          <p className='col-12 text-center text-white'>Have a supplier account? <span className='text-dark'>Sign in</span>.</p>
         ...
         <div className='container-fluid mt-5 d-sm-flex justify-content-sm-center d-lg-flex justify-content-lg-center d-md-flex justify-content-md-center'>
          ...
          >
           ...
           <div className='d-flex flex-column col-sm-10 col-md-11 col-lg-11'>
            <label className='mb-2 fw-bold'> Company Name</label>
            <input
            type="text"
            name="companyname" 
           ...
           <div className=' d-md-flex flex-md-row d-lg-flex flex-lg-row'>
            {/* Email_Id */}
            <div className='d-flex flex-column col-sm-10 col-lg-6 col-md-6'>
              <label className='mb-2 fw-bold'>Email (Account Username)</label>
              <input
              type="text"
              name="Email"  
              className='Form_Input mb-3 col-sm-12 col-md-10 col-lg-10'
           ...
           <div className=' d-md-flex flex-md-row d-lg-flex flex-lg-row'>
            ...
            <label className='mb-1 fw-bold'>Company Profile</label>
           ...
           <div className=' d-md-flex flex-md-row d-lg-flex flex-lg-row'>
            {/* Process_Work */}
            <div className='d-flex flex-column col-sm-10 col-lg-6 col-md-6'>
              <label className='mb-3 fw-bold'>Processes You Work With</label>
            ...
            {/* Web_URL */}
            <div className='d-flex flex-column col-sm-10 col-lg-6 col-md-6'>
            <label className='mb-2 fw-bold'>Web URL</label>
              <input
              type="text"
              name="Web URL"  
              className='Form_Input mb-3 col-sm-12 col-md-10 col-lg-10'
